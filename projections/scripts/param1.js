//***************path information*************** 
//path to .. mapserv binary
var exePfad = "/cgi-bin/mapserv";
//... machine name/ domain name
var host = "geocnt.geonet.ru";
//... application path (url-path to [...]/client/)
var applicationPath = "http://"+host+"/projections/";

//title for this application - appears on the page within the ScriptFrame
var aktuellBereichAlias = "Карты";

//legend setting - html legend or not?
hasHTMLLegend = true;

//...map file
var mapPfad = "/usr/local/www/data/site/projections/map/kras.map";
//var mapPfad = "/usr/local/www/data/client/map/rlp.map";
...
var fullExtent = "-4761512 -1549365 3761776 3754957";
...
mapList[6] = "cni";
//aliasname for maps
var mapAlias = new Array();
mapAlias[4] = "проекция Красовского";
mapAlias[2] = "проекция Ламберта-Гаусса";
mapAlias[0] = "проекция Каврайского";
mapAlias[1] = "проекция Нефедовой";
mapAlias[3] = "проекция до 1999";
mapAlias[7] = "вариант проекции 1745";
mapAlias[5] = "проекция Соловьева";
mapAlias[6] = "проекция ЦНИИГАиК";

var mapVisible = new Array();
mapVisible[0] = 1;
mapVisible[1] = 0;
mapVisible[2] = 0;
mapVisible[3] = 0;
...
layerList[1] = "grid";
layerList[2] = "frame";
layerList[3] = "towns_pnt";
layerList[4] = "hydr_line";
layerList[5] = "adm_t";
layerList[6] = "hydr2";
...
layerAlias[0] = "государства";
layerAlias[1] = "рамка";
layerAlias[2] = "сетка";
layerAlias[3] = "населенные пункты";
layerAlias[4] = "реки";
layerAlias[5] = "острова";
layerAlias[6] = "реки";
...
toolName[0] = "Sichtbare Themen wдhlen"; //fuer das "Auge" in der Navigationsleiste
toolName[1] = "North";
toolName[2] = "South";
toolName[3] = "East";
toolName[4] = "West";
...
//********************Frame sizes***************
var KopfHeight1 = 85; //Height for SkriptFrame (= Header)
